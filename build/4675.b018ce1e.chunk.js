...
`])),function(b){var O=b.theme,U=b.spacing;return O.spaces[U]}),D=y()(T.Flex).withConfig({shouldForwardProp:function(b,O){return!B[b]&&O(b)}})(o||(o=h()([`
  & > * {
    margin-left: 0;
    margin-right: 0;
  }
...
`])),15,function(N){return N.theme.colors.neutral0},function(N){return N.theme.colors.neutral150},function(N){return N.theme.borderRadius}),C=function(N){var R,w,E,W,k,j,x=N.source,z=N.children,Y=N.spacing,P=N.fullWidth,_=N.onReachEnd,Z=N.intersectionId,V=N.centered,K=h()(N,v),$=Object(t.useRef)(null),ln=Object(t.useState)(b(x.current,$.current,P,V,Y)),X=l()(ln,2),tn=X[0],q=tn.left,nn=tn.top,an=tn.width,dn=X[1];Object(D.a)([x,$],function(){return dn(b(x.current,$.current,P,V,Y))}),R=$,w=_,E={selectorToWatch:"#".concat(Z),skipWhen:!Z||!_},W=E.selectorToWatch,k=E.skipWhen,j=k!==void 0&&k,Object(t.useEffect)(function(){if(!j){var jn={root:R.current,rootMargin:"0px",threshold:1},yn=new IntersectionObserver(function(pn,vn){pn.forEach(function(hn){hn.isIntersecting&&R.current.scrollHeight>R.current.clientHeight&&w(hn)})},jn),Cn=R.current.querySelector(W);return yn.observe(Cn),function(){yn.disconnect()}}},[j,w,W]);var Nn={left:"".concat(q,"px"),top:"".concat(nn,"px"),width:an?"".concat(an,"px"):void 0};return e.a.createElement(O,{style:Nn,hasRadius:!0,background:"neutral0",padding:1},e.a.createElement(U,c()({ref:$},K),z,Z&&_&&e.a.createElement("div",{id:Z})))},m=function(N){return e.a.createElement(H.Portal,null,e.a.createElement(C,N))};C.defaultProps={fullWidth:!1,intersectionId:void 0,onReachEnd:void 0,centered:!1},C.propTypes={centered:y.a.bool,children:y.a.node.isRequired,fullWidth:y.a.bool,intersectionId:y.a.string,onReachEnd:y.a.func,source:y.a.shape({current:y.a.instanceOf(Element)}).isRequired,spacing:y.a.number}},,,,,,,,function(a,s,n){"use strict";n.d(s,"a",function(){return o});var i=n(1),o=function(d,c){Object(i.useEffect)(function(){var r=new ResizeObserver(c);return Array.isArray(d)?d.map(function(l){return r.observe(l.current)}):r.observe(d.current),function(){r.disconnect()}},[])}},,,,,function(a,s,n){"use strict";n.d(s,"c",function(){return t}),n.d(s,"b",function(){return e}),n.d(s,"a",function(){return g});var i,o,d,c=n(3),r=n.n(c),l=n(2),p=n.n(l),h=n(6),M=n(9),u=n(16),t=p()(M.Flex)(i||(i=r()([`
  position: relative;
  border: 1px solid `,`;
  padding-right: `,`;
  border-radius: `,`;
  ...
  `,`
`])),function(y){var T=y.theme;return y.hasError?T.colors.danger600:T.colors.neutral200},function(y){return y.theme.spaces[3]},function(y){return y.theme.borderRadius},function(y){return y.theme.colors.neutral0},Object(u.b)("input"),function(y){var T=y.theme;return y.disabled?`
...
`])),11/16,11/16,function(y){return y.theme.colors.neutral600}),g=p()(e)(d||(d=r()([`
  display: flex;
  background: none;
  border: none;
  cursor: `,`;
...
`])),function(y){return y.disabled?"not-allowed":void 0},6/16)},,,,,,,,,,,,,,,,,,,,function(a,s,n){"use strict";function i(r){return typeof r=="object"&&r!=null&&r.nodeType===1}function o(r,l){return(!l||r!=="hidden")&&r!=="visible"&&r!=="clip"}function d(r,l){if(r.clientHeight<r.scrollHeight||r.clientWidth<r.scrollWidth){var p=getComputedStyle(r,null);return o(p.overflowY,l)||o(p.overflowX,l)||function(h){var M=function(u){if(!u.ownerDocument||!u.ownerDocument.defaultView)return null;try{return u.ownerDocument.defaultView.frameElement}catch(t){return null}}(h);return!!M&&(M.clientHeight<h.scrollHeight||M.clientWidth<h.scrollWidth)}(r)}return!1}function c(r,l,p,h,M,u,t,e){return u<r&&t>l||u>r&&t<l?0:u<=r&&e<=p||t>=l&&e>=p?u-r-h:t>l&&e<p||u<r&&e>p?t-l+M:0}s.a=function(r,l){var p=window,h=l.scrollMode,M=l.block,u=l.inline,t=l.boundary,e=l.skipOverflowHiddenElements,g=typeof t=="function"?t:function(yn){return yn!==t};if(!i(r))throw new TypeError("Invalid target");for(var y=document.scrollingElement||document.documentElement,T=[],L=r;i(L)&&g(L);){if((L=L.parentElement)===y){T.push(L);break}L!=null&&L===document.body&&d(L)&&!d(document.documentElement)||L!=null&&d(L,e)&&T.push(L)}for(var B=p.visualViewport?p.visualViewport.width:innerWidth,H=p.visualViewport?p.visualViewport.height:innerHeight,D=window.scrollX||pageXOffset,v=window.scrollY||pageYOffset,b=r.getBoundingClientRect(),O=b.height,U=b.width,C=b.top,m=b.right,N=b.bottom,R=b.left,w=M==="start"||M==="nearest"?C:M==="end"?N:C+O/2,E=u==="center"?R+U/2:u==="end"?m:R,W=[],k=0;k<T.length;k++){var j=T[k],x=j.getBoundingClientRect(),z=x.height,Y=x.width,P=x.top,_=x.right,Z=x.bottom,V=x.left;if(h==="if-needed"&&C>=0&&R>=0&&N<=H&&m<=B&&C>=P&&N<=Z&&R>=V&&m<=_)return W;var K=getComputedStyle(j),$=parseInt(K.borderLeftWidth,10),ln=parseInt(K.borderTopWidth,10),X=parseInt(K.borderRightWidth,10),tn=parseInt(K.borderBottomWidth,10),q=0,nn=0,an="offsetWidth"in j?j.offsetWidth-j.clientWidth-$-X:0,dn="offsetHeight"in j?j.offsetHeight-j.clientHeight-ln-tn:0;if(y===j)q=M==="start"?w:M==="end"?w-H:M==="nearest"?c(v,v+H,H,ln,tn,v+w,v+w+O,O):w-H/2,nn=u==="start"?E:u==="center"?E-B/2:u==="end"?E-B:c(D,D+B,B,$,X,D+E,D+E+U,U),q=Math.max(0,q+v),nn=Math.max(0,nn+D);else{q=M==="start"?w-P-ln:M==="end"?w-Z+tn+dn:M==="nearest"?c(P,Z,z,ln,tn+dn,w,w+O,O):w-(P+z/2)+dn/2,nn=u==="start"?E-V-$:u==="center"?E-(V+Y/2)+an/2:u==="end"?E-_+X+an:c(V,_,Y,$,X+an,E,E+U,U);var Nn=j.scrollLeft,jn=j.scrollTop;w+=jn-(q=Math.max(0,Math.min(jn+q,j.scrollHeight-z+dn))),E+=Nn-(nn=Math.max(0,Math.min(Nn+nn,j.scrollWidth-Y+an)))}W.push({el:j,top:q,left:nn})}return W}},,,,,,function(a,s,n){"use strict";n.d(s,"a",function(){return D});var i,o,d=n(5),c=n.n(d),r=n(4),l=n.n(r),p=n(3),h=n.n(p),M=n(1),u=n.n(M),t=n(0),e=n.n(t),g=n(2),y=n.n(g),T=n(18),L=["children","small"],B=Object(g.keyframes)(i||(i=h()([`
  from {
...
`])),2.5,.875,function(f){return f.theme.colors.neutral800}),yn=q()(V.Box)(Y||(Y=X()([`
  width: 100%;
  border: none;
  text-align: left;
  outline-offset: -3px;
